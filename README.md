# REDHAWK Basic Components DataReader
 
## Description

Contains the source and build script for the REDHAWK Basic Components DataReader.
...
REDHAWK Basic Components DataReader is licensed under the GNU Lesser General Public License (LGPL).
